...
export const PILLAR_URL = `${SHEET_SERVER_URL}/sheet/${META_SHEET_ID}?range=indicators-phase2`

export const SOURCES_URL = `${SHEET_SERVER_URL}/sheet/${META_SHEET_ID}?range=last-updated`

export const KEY_STATS_URL = `${SHEET_SERVER_URL}/sheet/${META_SHEET_ID}?range=pillars-key-stats`
